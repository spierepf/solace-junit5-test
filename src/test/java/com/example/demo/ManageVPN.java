...
public class ManageVPN {
    ...
    private void handleError(RestClientException ae) {
        Gson gson = new Gson();
        String responseString = ae.getMessage();
        ...
        System.out.println("Error during operation. Details:" + 
                "\nHTTP Status Code: " + ae.getMessage() + 
    ...
    public void createMessageVpn(String messageVpnName) throws RestClientException {
    ...
    public void updateDefaultClientProfileForPersistentMessaging(String messageVpnName) throws RestClientException {
    ...
    public void setupClientUsername(String messageVpnName, String clientName, String clientPassword) throws RestClientException {
    ...
    public void createQueue(String messageVpnName, String queueName ) throws RestClientException {
    ...
    public void deleteMessageVpn(String messageVPNName) throws RestClientException {
    ...
    public void deleteQueue(String messageVpnName, String queueName) throws RestClientException {
